...
<template>
    <FramedMainSection id="about-me" class="min-h-[100dvh] flex relative">
        <div
            class="h-full w-full rounded-[2rem] bg-[url('https://github.com/Cyprien-png/portfolio/blob/main/public/backgrounds/room.jpg?raw=true')] bg-cover bg-right text-white flex justify-center items-end text-center p-4">
