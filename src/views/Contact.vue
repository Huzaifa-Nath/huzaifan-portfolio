...
import Parallax from '../components/ParallelX.vue';
...
<template>
    <FramedMainSection ref="frameRef" id="contact" class="h-dvh">
        <Parallax>
            <div ref="contactSectionRef" class="h-full w-full relative rounded-[2rem] flex flex-col pt-24">
                <div class=" absolute h-full w-full top-0 left-0 rounded-[2rem] brightness-[.85]  bg-[url('/backgrounds/sky.png')] bg-cover -z-10 overflow-hidden">
                    <div class="h-full w-full flex justify-center items-end relative">
                        <img src="/backgrounds/mountains.png" alt="" data-parallax-value=".005" class="hidden lg:absolute h-auto  w-full scale-110 object-cover parallax"/>
                ...
                <div class="flex flex-col justify-center items-center text-[10dvw] leading-none w-full h-full font-rubik">
                    <h1 class="text-white">Huzaifa</h1>
